          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-base md:text-lg">
              <TrackedButton
                ...
                className="w-full sm:w-auto bg-fuchsia-600 hover:bg-fuchsia-500 text-white font-medium px-6 py-3 rounded-lg shadow-lg shadow-fuchsia-900/20 transform hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:ring-opacity-50 cursor-pointer"
              >
                Get started
              </TrackedButton>
              <TrackedButton
