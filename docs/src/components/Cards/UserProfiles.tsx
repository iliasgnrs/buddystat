...
export function UserProfiles() {
  return (
    <Card title="User Profiles" description="Know who your users are and exactly what they do.">
      <div className="bg-neutral-900 p-4 rounded-md">
        <div className="flex items-start gap-4">
          {/* User basic info */}
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-4">
              <Avatar size={32} id="john-doe" />
              <div>
                <div className="text-neutral-50">John Doe</div>
