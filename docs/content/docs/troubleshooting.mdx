...
description: Docker cleanup and troubleshooting guide for BuddyStat
---
...
<Callout type="warn">
**Warning**: This will remove ALL Docker containers, images, and volumes on your system, not just BuddyStat-related ones. Make sure you don't have other important Docker containers running.
</Callout>
...
### Alternative: BuddyStat-Specific Cleanup

If you only want to clean up BuddyStat-related Docker resources without affecting other containers, use these commands instead:

```bash
# Stop and remove BuddyStat containers
docker-compose down

# Remove BuddyStat images
docker-compose down --rmi all

# Remove BuddyStat volumes (this will delete your data!)
docker-compose down --volumes

# Complete BuddyStat cleanup
docker-compose down --rmi all --volumes --remove-orphans
```

### After Cleanup

Once you've completed the cleanup, you can restart BuddyStat by following the setup instructions:
