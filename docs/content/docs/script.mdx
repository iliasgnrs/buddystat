...
description: How to install and configure the BuddyStat tracking script
---

import { Callout } from 'fumadocs-ui/components/callout';

To start tracking user activity on your website, add the BuddyStat tracking script to your site's HTML.
...
```
If you are self-hosting BuddyStat `app.buddystat.com` will be domain of your BuddyStat instance.
...
Most tracking options are configured through your site settings in the BuddyStat dashboard. The script automatically fetches these settings when it loads:
