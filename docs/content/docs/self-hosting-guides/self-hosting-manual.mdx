...
description: Manual setup guide for BuddyStat using Docker Compose without the setup script
---
...
This guide is for users who want to manually set up BuddyStat using Docker Compose without the setup script. This is useful if you already have a reverse proxy setup (like Nginx, Traefik, or Coolify), or if you want more control over the configuration.
...
BuddyStat consists of these services:
...
To deploy BuddyStat on Coolify, you need to:
...
These guides provide step-by-step instructions for integrating BuddyStat with your existing infrastructure.
