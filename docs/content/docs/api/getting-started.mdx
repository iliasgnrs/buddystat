...
description: Authentication, common parameters, and best practices for the BuddyStat Stats API
---
...
The easiest way to explore and test the API is using the built-in **API Playground** in your BuddyStat dashboard. Access it by navigating to any site and clicking "API Playground" in the sidebar.
