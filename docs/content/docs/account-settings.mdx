...
Generate API keys to access BuddyStat's analytics endpoints from your applications.
...
Include your API key in requests to BuddyStat's API endpoints. See the [API documentation](/docs/api) for available endpoints and usage examples.
