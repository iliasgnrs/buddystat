---
title: Drupal
description: Integrate BuddyStat Analytics with your Drupal site using theme files or modules
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

Integrating BuddyStat Analytics with your Drupal site can be done by adding the tracking script to your theme or by using a module that allows adding custom JavaScript.
...
Open the `html.html.twig` file and paste the BuddyStat tracking script just before the closing `</body>` tag.
...
- Click **+ Add JS inject**.
- **Label:** Give it a name like "BuddyStat Analytics".
- **Code:** Paste your BuddyStat tracking script into the code field.
...
That's it! BuddyStat Analytics should now be integrated with your Drupal site.