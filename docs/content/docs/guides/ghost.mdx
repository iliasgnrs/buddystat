---
title: Ghost
description: Integrate BuddyStat Analytics with your Ghost blog or publication
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

Ghost is a powerful publishing platform for blogs and publications. You can easily add BuddyStat Analytics using Ghost's built-in code injection feature.

## How to Add BuddyStat to Ghost
...
Ghost's membership features work normally with BuddyStat. All page views, including member-only content, will be tracked (for visitors who have access to view the content).
