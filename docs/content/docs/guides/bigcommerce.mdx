---
title: BigCommerce
description: Integrate BuddyStat Analytics with your BigCommerce store
---
...
BigCommerce is a leading e-commerce platform for online stores. You can integrate BuddyStat Analytics to track visitor behavior and conversions.

## How to Add BuddyStat to BigCommerce

<Tabs items={['Script Manager (Recommended)', 'Theme Files']}>
<Tab>
### Using Script Manager

The easiest way to add BuddyStat to BigCommerce is through the Script Manager.
...
- **Name**: BuddyStat Analytics
- **Description**: BuddyStat Analytics tracking script
- **Placement**: Head
- **Location**: All pages
...
To get the most out of BuddyStat with BigCommerce, you can track key e-commerce events like product views and purchases.
