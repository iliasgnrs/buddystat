---
title: Hugo
description: Integrate BuddyStat Analytics with your Hugo static site using partial templates
---

import { Steps, Step } from 'fumadocs-ui/components/steps';

Integrating BuddyStat Analytics with your Hugo static site involves adding the tracking script to your site's templates. The best way to do this is by creating a partial template for the script and including it in your site's footer.
...
Paste your BuddyStat tracking script into this new file:
...
- Replace `https://app.buddystat.com` and `YOUR_SITE_ID` with your actual details.
</Step>
...
Open your main base template or footer partial file. Just before the closing `</body>` tag, add the following line to include your BuddyStat Analytics partial:
...
{{ if and (not .Site.IsServer) .Site.Params.rybbitSiteID }}
  <script async defer src="{{ .Site.Params.rybbitInstanceURL | default "https://app.buddystat.com" }}/api/script.js" data-site-id="{{ .Site.Params.rybbitSiteID }}"></script>
{{ end }}
```
</Step>
...
```toml
[params]
  rybbitInstanceURL = "https://app.buddystat.com" # Your BuddyStat instance URL
  rybbitSiteID = "YOUR_SITE_ID" # Your BuddyStat Site ID
```
...
That's it! BuddyStat Analytics is now integrated with your Hugo site and will only track visits on your production deployment.