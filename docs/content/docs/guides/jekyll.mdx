---
title: Jekyll
description: Integrate BuddyStat Analytics with your Jekyll static site using layout files or includes
---

import { Steps, Step } from 'fumadocs-ui/components/steps';

Integrating BuddyStat Analytics with your Jekyll static site involves adding the tracking script to your site's main layout file or by creating an include file.
...
Open this file and paste the BuddyStat tracking script just before the closing `</body>` tag.
...
- Replace `YOUR_SITE_ID` with your actual Site ID. The script source `https://app.buddystat.com/api/script.js` is for the standard cloud-hosted BuddyStat instance.
</Step>
</Steps>
...
{% if jekyll.environment == "production" and site.rybbit_site_id %}
  <script async defer src="{{ site.rybbit_instance_url | default: 'https://app.buddystat.com' }}/api/script.js" data-site-id="{{ site.rybbit_site_id }}"></script>
{% endif %}
{% endraw %}
```
</Step>
...
- Open your `_config.yml` file and add your BuddyStat details:

```yaml
# BuddyStat Analytics Configuration
rybbit_instance_url: "https://app.buddystat.com" # Optional, defaults in include
...
That's it! BuddyStat Analytics is now integrated with your Jekyll site and will only track visits on your production deployment.