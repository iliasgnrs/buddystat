...
description: Integrate BuddyStat with your client-side Svelte application
---
...
This guide explains how to integrate BuddyStat with your standard client-side Svelte applications, typically built using Vite (e.g., via `npm create vite@latest -- --template svelte`).

## How to Add BuddyStat to Your Client-Side Svelte App

The most straightforward method is to add the BuddyStat tracking script directly to your `index.html` file.
...
Open `index.html` and paste the BuddyStat tracking snippet just before the closing `</head>` tag or `</body>` tag.
