...
description: Integrate BuddyStat Analytics with your website using Google Tag Manager
---

import { Steps, Step } from 'fumadocs-ui/components/steps';


Google Tag Manager (GTM) allows you to add code snippets or tracking pixels to your website with minimal code changes. This makes it an efficient way to integrate BuddyStat without modifying your codebase.

## How to Add BuddyStat to Google Tag Manager
...
Under **Tag Configuration**, choose **Custom HTML** and paste your BuddyStat snippet into the provided field.
</Step>

<Step>
### Set Up Triggers

Assign a trigger to determine when the tag should fire. For instance, to load BuddyStat on all pages, select the **All Pages** trigger.
</Step>
...
Once BuddyStat is loaded through GTM, you can track custom events using JavaScript. Since GTM already handles the script loading, you can directly call the BuddyStat tracking functions.
...
Once BuddyStat is loaded via GTM, you can track events directly from your website's JavaScript:
...
You can leverage GTM's built-in variables and triggers to send custom events to BuddyStat:
