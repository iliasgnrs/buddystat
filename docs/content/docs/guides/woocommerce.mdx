...
1.  **Rybbit Installed on WordPress**: Ensure you have already installed the BuddyStat tracking script on your WordPress site using one of the methods described in our [WordPress integration guide](/docs/guides/wordpress). This guide focuses on adding e-commerce event tracking.
