---
title: GitBook
description: Integrate BuddyStat Analytics with your GitBook documentation
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

GitBook is a popular platform for creating documentation and knowledge bases. You can add BuddyStat Analytics to track how visitors use your documentation.

<Callout type="warn">
Custom scripts require a **Pro plan or higher** and a **custom domain** configured for your GitBook space.
</Callout>

## How to Add BuddyStat to GitBook
