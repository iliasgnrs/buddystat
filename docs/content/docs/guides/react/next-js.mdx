---
title: Next.js
description: Integrate BuddyStat with your Next.js application for analytics tracking
---
...
Next.js is a popular React framework that enables features like server-side rendering and static site generation. This guide explains how to integrate BuddyStat with your Next.js application.

## How to Add BuddyStat to Next.js

<Steps>
<Step>
### Retrieve Your Tracking Script

Navigate to your BuddyStat dashboard to obtain your site ID. You'll need this for the `data-site-id` attribute.
</Step>
...
While BuddyStat is not using any cookied based tracking and is fully compliant
...
# use this value if you are self-hosting BuddyStat
NEXT_PUBLIC_RYBBIT_HOST=https://your-hosted-rybbit-instance.com

# use this value if you are using the BuddyStat hosted tracking
