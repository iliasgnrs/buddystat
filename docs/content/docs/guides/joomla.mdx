---
title: Joomla
description: Integrate BuddyStat Analytics with your Joomla website
---
...
Joomla is a popular open-source content management system. Here's how to add BuddyStat Analytics to your Joomla site.

## How to Add BuddyStat to Joomla
...
- **Title**: BuddyStat Analytics (or any name you prefer)
- **Show Title**: No
