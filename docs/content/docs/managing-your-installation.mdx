...
BuddyStat is updated frequently with new features and bug fixes. You can update your installation by running the following commands:
...
To help us improve BuddyStat, self-hosted instances automatically send anonymous usage statistics to our cloud service. This includes:
