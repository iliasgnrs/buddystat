...
description: Deploy BuddyStat proxy on Vercel with Edge Network caching
---

import { Steps } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

Vercel makes it easy to proxy BuddyStat tracking through their Edge Network. If you're using Next.js, follow the [Next.js proxy guide](/docs/proxy-guide/next-js) instead, which is optimized for Next.js applications.
...
**What you'll achieve:**
- Proxy BuddyStat through Vercel's Edge Network
- Automatic global caching and CDN distribution
- Simple JSON configuration
- Support all BuddyStat features
  ...
  "rewrites": [
    {
      ...
      "destination": "https://app.buddystat.com/api/script.js"
    },
    {
      "source": "/analytics/replay.js",
      "destination": "https://app.buddystat.com/api/replay.js"
    },
    {
      "source": "/analytics/metrics.js",
      "destination": "https://app.buddystat.com/api/metrics.js"
    },
    {
      "source": "/analytics/track",
      "destination": "https://app.buddystat.com/api/track"
    },
    {
      "source": "/analytics/identify",
      "destination": "https://app.buddystat.com/api/identify"
    },
    {
      "source": "/analytics/session-replay/record/:siteId",
      "destination": "https://app.buddystat.com/api/session-replay/record/:siteId"
    },
    {
      "source": "/analytics/site/tracking-config/:siteId",
      "destination": "https://app.buddystat.com/api/site/tracking-config/:siteId"
    }
  ]
}
```
...
```bash
git add vercel.json
git commit -m "Add BuddyStat proxy configuration"
git push
```
...
3. **Verify in BuddyStat dashboard**: Data should appear after 1-2 minutes
...
2. Edge server rewrites and proxies to BuddyStat
...
**Problem**: Requests still go to `app.buddystat.com` directly.
...
// vercel.staging.json (staging)
{
  "rewrites": [
    {
      "source": "/analytics/script.js",
      "destination": "https://staging.buddystat.com/api/script.js"
    }
  ]
}
```
...
```json
// ❌ Wrong - uses redirects (user sees app.buddystat.com)
{
  "redirects": [
    {
      "source": "/analytics/script.js",
