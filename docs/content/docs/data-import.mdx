...
The data import feature allows you to migrate your historical analytics data from other platforms to BuddyStat. This preserves your analytics history when switching from competitors, giving you a complete view of your data without losing valuable insights.
...
Currently, BuddyStat supports importing data from:
...
1. Open your BuddyStat dashboard
...
- Continue using BuddyStat while the import runs
...
**Imported Events**
- Number of events successfully imported into BuddyStat
