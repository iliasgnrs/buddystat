...
BuddyStat can automatically capture common user interactions without requiring any code changes. These features can be enabled in your [Site Settings](/docs/site-settings) under the "Auto Capture" section.
...
When enabled, BuddyStat automatically tracks clicks on links that navigate to external domains.
