...
To properly investigate what's going on, you'll need a solid analytics tool with [web analytics capabilities](/blog/what-is-web-analytics) to understand traffic patterns and [bounce rate analysis](/blog/bounce-rate) to identify engagement issues. We obviously recommend BuddyStat (and we'll show you exactly how to use it), plus you'll want access to an SEO tool and Google Search Console. By walking through Rybbit's specific features, we'll show you how to diagnose what's actually causing your traffic to tank.
