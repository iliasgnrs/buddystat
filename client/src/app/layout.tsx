    ...
    <html lang="en" suppressHydrationWarning>
      ...
      <NuqsAdapter>
        <body className={cn("bg-background text-foreground h-full", inter.className)} suppressHydrationWarning>
          ...
          {appEnv === "prod" && (
            <Script src="https://buddystat.com/api/script.js" data-site-id="21" strategy="afterInteractive" />
          )}
          {appEnv === "demo" && (
            <Script src="https://buddystat.com/api/script.js" data-site-id="22" strategy="afterInteractive" />
          )}
